...
if ( ! function_exists( 'unitedthemes_scripts' ) ) :
    ...
    function unitedthemes_scripts() {
		...
		*/
        ...
        /* fancy slider */
        if( (is_front_page() && ot_get_option('ut_front_page_header_type') == 'transition') || (is_home() && ot_get_option('ut_blog_header_type') == 'transition' ) ) {
...
if( !function_exists('ut_create_bg_videoplayer') ) :
	...
	function ut_create_bg_videoplayer() {
		...
		if( !$detect->isMobile() && !$detect->isTablet() && !is_singular('portfolio') ) : 
